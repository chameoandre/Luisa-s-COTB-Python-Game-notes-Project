...
\label{sec: Etapa 6: Interação e Feedback (Entrada do Usuário + Sons)}
    ...
    def desenhar_estrela(surface, x, y, size, color):
        pts = [(x, y - size), (x + size*0.3, y - size*0.3), (x + size, y - size*0.3),
               ...
               (x - size*0.3, y - size*0.3)]
        pygame.draw.polygon(surface, color, pts)
\begin{boxTutorial}{Tutorial 5: Telas e Gráficos Simples com Pygame}
\label{sec: Etapa 5: Pygame Screens}

    Criação de janelas, desenho de formas geométricas e gerenciamento de cores.
    
    \subsubsection*{Objetivos}
    \begin{itemize}
        \item Manipular o sistema de coordenadas do Pygame.
        \item Desenhar alvos lúdicos (estrelas, círculos).
    \end{itemize}
    
    \begin{minted}{python}
screen.fill((20, 30, 80)) # Cor do céu
pygame.draw.circle(screen, (255, 255, 255), (400, 240), 50)
    \end{minted}
    
    \subsubsection*{Resultados de Aprendizagem}
    \begin{itemize}
        \item Domínio básico de renderização 2D.
    \end{itemize}
\end{boxTutorial}
